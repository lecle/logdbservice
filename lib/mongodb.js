...
exports.init = function(container, callback) {
    ...
    var mongodbConnectionString = container.getConfig('logMongodbConnectionString') || container.getConfig('mongodbConnectionString');
    ...
    if(mongodbConnectionString) {
        ...
        var config = container.getConfig('logMongodb');
